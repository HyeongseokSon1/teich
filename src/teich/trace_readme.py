    ...
    *,
    ...
    lines.extend(
        [
            ...
            "",
            "Load this dataset, format it with your tokenizer, build a Teich collator,",
            "and run SFT audits in one step:",
            "",
            "```python",
            ...
            "sft_config_kwargs = prepared.sft_config_kwargs",
            "```",
            "",
            "When using TRL `SFTTrainer`, pass `prepared.dataset`, `prepared.collator`,",
            "and `**prepared.sft_config_kwargs` so TRL keeps Teich's precomputed labels intact.",
            "",
